...
M.colors = {
    ...
    TableRow        = 'Normal',
    TableRule       = 'RenderMarkdownTableHead',
    TableRowRule    = 'Comment',
    ...
    Mermaid         = 'Normal',
    MermaidActive   = 'DiagnosticInfo',
    MermaidArrow    = 'Special',
    MermaidCritical = 'DiagnosticError',
    MermaidDone     = 'Comment',
    MermaidEdge     = 'Comment',
    MermaidEdgeLabel = 'String',
    MermaidItalicLabel = 'Italic',
    MermaidBoldLabel = 'Bold',
    MermaidContentLabel = 'Normal',
    MermaidMilestone = 'Constant',
    MermaidNode     = 'Identifier',
    MermaidSubgraph = 'Comment',
    MermaidSubgraphLabel = 'Title',
    MermaidIcon     = 'Title',
    MermaidLabel    = 'Title',
    MermaidSection1 = 'RenderMarkdownH1',
    MermaidSection2 = 'RenderMarkdownH2',
    MermaidSection3 = 'RenderMarkdownH3',
    MermaidSection4 = 'RenderMarkdownH4',
    MermaidSection5 = 'RenderMarkdownH5',
    MermaidSection6 = 'RenderMarkdownH6',
    -- Callouts
